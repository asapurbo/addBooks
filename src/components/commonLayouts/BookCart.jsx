...
import DeletedBook from '../../redux/thunk/DeletedBook';

const BookCart = ({ thumbnail, featured, name, price, rating, author, info }) => {
  const dispatch = useDispatch()
  const {id} = info
  const handleEdit = () => {
    dispatch(editBook(info))
  }
        ...
        <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
          <div className="flex items-center justify-between">
            ...
            <div className="text-gray-500 space-x-2">
              <button onClick={() => handleEdit(info)} className="lws-edit">
                <svg
                  fill="none"
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
              ...
              <button onClick={() => handleDeleted(id)} className="lws-delete">
                <svg
                  fill="none"
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
          ...
          <div className="space-y-2 mt-4 h-full">
            ...
            <div className="lws-stars">{Rating(rating)}</div>
